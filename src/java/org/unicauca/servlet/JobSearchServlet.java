...
import org.unicauca.webclient.JobSearchWebService;
import org.unicauca.webclient.JobSearchWebService_Service;
...
public class JobSearchServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("getJobOffer") != null){
            try{
                JobSearchWebService_Service service = new JobSearchWebService_Service();
                JobSearchWebService port = service.getJobSearchWebServicePort();
